            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('delivery', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/deliveries/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                <FormListItem label="Delivery Address" text={data?.delivery_address} />

                <FormListItem label="Delivery City" text={data?.delivery_city} />

                <FormListItem label="Delivery State" text={data?.delivery_state} />

                <FormListItem label="Delivery Postal Code" text={data?.delivery_postal_code} />

                <FormListItem label="Delivery Country" text={data?.delivery_country} />
