...
export function DeliveryListPage(props: DeliveryListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getDeliveries({
        ...
        order: params.order,
        searchTermKeys: [
          'delivery_address.contains',
          'delivery_city.contains',
          'delivery_state.contains',
          'delivery_postal_code.contains',
          'delivery_country.contains',
        ],
        ...(params.filters || {}),
      }),
  ...
  const columns: ColumnType[] = [
    { id: 'delivery_address', header: 'Delivery Address', accessorKey: 'delivery_address' },
    { id: 'delivery_city', header: 'Delivery City', accessorKey: 'delivery_city' },
    { id: 'delivery_state', header: 'Delivery State', accessorKey: 'delivery_state' },
    { id: 'delivery_postal_code', header: 'Delivery Postal Code', accessorKey: 'delivery_postal_code' },
    { id: 'delivery_country', header: 'Delivery Country', accessorKey: 'delivery_country' },
      ...
      ? {
          ...
          cell: ({ row: { original: record } }: any) => (
            <Flex justifyContent="flex-end">
              <NextLink href={`/deliveries/view/${record.id}`} passHref legacyBehavior>
                <Button
