  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Food Delivery Application - Revolutionizing the Way You Dine. Experience the ease of having your favorite meals delivered right to your doorstep, anytime, anywhere."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1589010588553-46e8e7c21788?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxmb29kJTIwZGVsaXZlcnl8ZW58MHx8fHwxNjk1ODE0MTA5fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Food Delivery Application - Revolutionizing the Way You Dine. Experience the ease of having your favorite meals delivered right to your doorstep, anytime, anywhere.`}
            </Text>
            <Box
